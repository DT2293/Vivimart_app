...
//        //}
//        public IActionResult SalePage(string? phoneNumber,int? categoryId, int? invoiceId = null,int page = 1)
//        {
//            // Lấy danh sách sản phẩm
//            var products = _productServiceFs.ListProduct(categoryId, page);

//            // Lưu số điện thoại vào Session hoặc Database (tuỳ nhu cầu)
//            if (!string.IsNullOrEmpty(phoneNumber))
//            {
//                // Giả sử lưu vào Session
...
//        //    // Get cart items
//        //    var cartItems = GetCartItems();
//        //    var phonenumber = HttpContext.Session.GetString("PhoneNumber", phoneNumber);
...
//        //}
//        [HttpGet]
//        public IActionResult CreateInvoice(string phone)
//        {
//            // Check if user is logged in
//            if (HttpContext.Session.GetString("Username") == null)
//            {
...
//                    // Create list of invoice details from cart items
...
//            // Redirect to SalePage if there's an error or invalid model
...
//        //          var customer = _db.Customers.Include(i => i.Invoices).ThenInclude(d => d.Customer).FirstOrDefault(i => i.in);
...
//        //      }
//        public async Task<IActionResult> InvoiceDetails(int id, string phoneNumber)
//        {
//            // Fetch invoice, customer, and invoice details using the phone number and invoice ID
...
//            // Map data to InvoiceDetailsViewModel
//            var invoiceDetailsViewModel = new InvoiceDetailsViewModel
//            {
//                InvoiceId = invoice.InvoiceId,
//                UserId = invoice.UserId,
