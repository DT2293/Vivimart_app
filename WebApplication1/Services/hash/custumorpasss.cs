    ...
    public class CustomPasswordHasher
    {
        ...
        public string getBasicAuthSalt()
        {
            try
            {
                ...
                string basicAuthSalt = Path.GetRandomFileName().Replace(".", "");
        ...
        /// <summary>
        /// giá trị realmString khi cài đặt ODK Aggregate
        /// </summary>
        /// <returns></returns>
        public string getRealmInfo()
        {
          return "hcr ODK Aggregate";

            // khi cài đặt ODK thì có nhập
            //security.server.realm.realmString=hcr ODK Aggregate
            //tìm theo đường dẫn
            //\src\main\resources\security.properties
            //\webapps\testAggregate\WEB - INF\lib\ODKAggregate - settings.jar\security.properties
            // hoặc trong table _server_preferences_properties của CSDL
        }
